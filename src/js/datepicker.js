...
/* WEBPACK VAR INJECTION */(function($) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*!
 *	===========================================================
...
(function (factory) {
    ...
    Date.prototype.Format = function (format) {
        if (!/^[\\\/:YHGmndhgijs-\s\u5e74\u6708\u65e5\u65f6\u5206\u79d2]+$/.test(format)) {
            ...
            for (var i = 0; i < matchs.length; i++) {
                format = format.replace(matchs[i], matchs[i] === "Y" ? this.getFullYear() : matchs[i] === "m" ? (this.getMonth() + 1).toLead(2) : matchs[i] === "d" ? this.getDate().toLead(2) : matchs[i] === "n" ? this.getMonth() + 1 : matchs[i] === "j" ? this.getDate() : matchs[i] === "h" ? this.getHours().toLead(2) : matchs[i] === "H" ? this.getHours().toLead(2) : matchs[i] === "g" ? this.getHours() % 12 || 12 : matchs[i] === "G" ? this.getHours() : matchs[i] === "i" ? this.getMinutes().toLead(2) : this.getSeconds().toLead(2));
            }
            return format;
        }
    };
    ...
    var datepicker = function (today, selectHis, lang) {
        ...
        // 拼接日期面板HTML串
        var htmls = '<div id="datepicker" class="date-picker-box right dropmain animates">' + '<div class="date-picker-top">' + '<div class="date-button-prev" id="date_year_prev"><i class="dicon-prev"></i><i class="dicon-prev"></i></div>' + '<div class="date-button-prev" id="date_month_prev"><i class="dicon-prev"></i></div>' + '<div class="date-picker-head">' + this.style.title + '</div>' + '<div class="date-button-next" id="date_month_next"><i class="dicon-next"></i></div>' + '<div class="date-button-next" id="date_year_next"><i class="dicon-next"></i><i class="dicon-next"></i></div>' + '</div>' + '<ul class="date-picker-list" id="date_picker_week">' + weekStr + '</ul>' + '<ul class="date-picker-list" id="date_picker_day"></ul>' + '<ul class="date-picker-list date-picker-years" id="date_picker_years"></ul>' + '<div class="date-picker-today" id="date_today">Today</div>' + '</div>';
    ...
    datepicker.prototype = {
        ...
        */
        ...
        hisInit: function (hour, minute, second) {
            ...
            var his_str = '<ul class="date-picker-list date-picker-hour" id="date_picker_hour">' + hour_str + '</ul>' + '<ul class="date-picker-list date-picker-minute" id="date_picker_minute">' + minute_str + '</ul>' + '<ul class="date-picker-list date-picker-second" id="date_picker_second">' + second_str + '</ul>';
        ...
        _event: function () {
            ...
            _ele_day.click(function (e) {
                var target = $(e.target);
                var month = _this.selectDay.getMonth(),
                    newDate = new Date(_this.selectDay);
