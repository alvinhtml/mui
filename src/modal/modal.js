	...
	$.extend({
		...
		*/
		Alert:function(text){
			...
			$('<div class="modal animate Alert">'
		  	...
		  	+ '<div class="actions"><span class="button green close">知道了</span></div>'
		...
		*/
		Confirm:function(text,fn,fn2){
			...
			// 向body添加弹框DOM，并显示
			$('<div class="modal animate Confirm">'
			...
			+ '<div class="actions"><span id="ConfirmNo" class="button close"> 取消 </span><span id="ConfirmOk" class="button green label close"><i class="fa fa-check"></i> 确认</span></div>'
